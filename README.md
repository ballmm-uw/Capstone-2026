# AIP Oral History NLP Capstone Project
 
In collaboration with the UW Lab for Computing Cultural Heritage, professor Ben Lee, and American Institute of Physics, and AIP Chief Research Officer Trevor Owens, our MLIS capstone project explored the application of artificial intelligence and other natural language processing tools to the AIP Oral History collection in order to evaluate these tools potential for use for metadata creation, analysis, validation, and description. Our experiments resulted in the development of crowdsourcing tools that incorporate programatic methods to identify and improve public descriptions of AIP Oral History subjects.
 
The AIP Oral History collection can be found here: https://www.aip.org/history/oral-history
 
---
 
## Final Deliverables
 
Our final deliverables for the project can be broken down into three categories:
